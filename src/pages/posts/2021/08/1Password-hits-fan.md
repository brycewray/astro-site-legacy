...
<YellowBox>
<strong>Overall update, 2021-09-16</strong>: Based on my testing, I can recommend the KeePassXC/KeePassium route for those who want to use the “KeePass way.” However, I didn’t like the occasional glitchiness of KeePassXC browser extensions, so I decided to stick with Bitwarden for passwords <strong>only</strong> while adopting—and really liking—the <a href="https://github.com/raivo-otp/ios-application" target="_blank" rel="nofollow">Raivo OTP</a> authenticator app for my TOTPs, after dropping <a href="https://authy.com/" target="_blank" rel="nofollow">Authy</a> due primarily to what I learned from that Techlore video mentioned above.
</YellowBox>
